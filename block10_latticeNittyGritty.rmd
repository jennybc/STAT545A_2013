...
Now I write a custom panel function 'on the fly' but the function body just consists of the defaul panel function.  I omit the plot because there is no visible change, which is exactly what I want right now.
...
Now I modify the a custom panel function to have arguments `x`, `y`, and `...`. I omit the plot because there is no visible change, which is exactly what I want right now.
...
Now I take control of the plotting symbol: I make it an empty circle. I also scale the diameter of the circle to reflect the country's population. The logic and testing of this mapping of population into circle size was done elsewhere and required some thought and care, FYI. 
