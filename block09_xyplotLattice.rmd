...
We focus on studying the relationship between two quantitative variables -- possibly in conjunction with one or more categorical variables. We are going to use the `xyplot()` from the `lattice` package in this tutorial and will revisit this ground using `ggplot2` shortly.
