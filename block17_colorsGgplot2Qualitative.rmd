...
This is deceptively simple at this point. Like many things, it looks really easy, once someone figures everything out! On the left you see the simple endpoint of this tutorial. The right-hand figure is produced with exactly the same `ggplot2` code but applied to a reordered input dataset (code to create `finalPlot` not shown here by available in the [source](https://github.com/jennybc/STAT545A/blob/master/block17_colorsGgplot2Qualitative.rmd)).
